...
![s21_decimal](vid/stock.gif)

Планета Земля, 90 годы. Инвесторы пытаются предсказать движение рынка, используя обычный IEEE 754 (float). 

Тогда на помощь приходит тип Decimal, который представляет десятичные числа в диапазоне от положительных 79,228,162,514,264,337,593,543,950,335 до отрицательных 79,228,162,514,264,337,593,543,950,335. 
...
Двоичное представление Decimal реализовано в виде четырехэлементного массива 32-разрядных целых чисел со знаком (`int bits[4];`).
