...
CREATE TABLE person (
    id bigint PRIMARY KEY, name varchar NOT NULL, age integer NOT NULL DEFAULT 10, gender varchar DEFAULT 'female' NOT NULL, address varchar
);
...
CREATE TABLE pizzeria (
    id bigint PRIMARY KEY, name varchar NOT NULL, rating numeric NOT NULL DEFAULT 0
);
...
CREATE TABLE person_visits (
    id bigint PRIMARY KEY, person_id bigint NOT NULL, pizzeria_id bigint NOT NULL, visit_date DATE NOT NULL DEFAULT CURRENT_DATE, CONSTRAINT uk_person_visits UNIQUE (
        person_id, pizzeria_id, visit_date
    ), CONSTRAINT fk_person_visits_person_id FOREIGN KEY (person_id) REFERENCES person (id), CONSTRAINT fk_person_visits_pizzeria_id FOREIGN KEY (pizzeria_id) REFERENCES pizzeria (id)
);
...
CREATE TABLE menu (
    id bigint PRIMARY KEY, pizzeria_id bigint NOT NULL, pizza_name varchar NOT NULL, price numeric NOT NULL DEFAULT 1, CONSTRAINT fk_menu_pizzeria_id FOREIGN KEY (pizzeria_id) REFERENCES pizzeria (id)
);
...
CREATE TABLE person_order (
    id bigint PRIMARY KEY, person_id bigint NOT NULL, menu_id bigint NOT NULL, order_date DATE NOT NULL DEFAULT CURRENT_DATE, CONSTRAINT fk_order_person_id FOREIGN KEY (person_id) REFERENCES person (id), CONSTRAINT fk_order_menu_id FOREIGN KEY (menu_id) REFERENCES menu (id)
);
